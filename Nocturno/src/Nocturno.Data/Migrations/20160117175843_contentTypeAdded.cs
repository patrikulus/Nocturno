    ...
    public partial class contentTypeAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CmsContentType", x => x.Id);
                });
            migrationBuilder.CreateTable(
                name: "CmsFieldType",
                columns: table => new
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CmsFieldType", x => x.Id);
                });
            migrationBuilder.CreateTable(
                name: "Content",
                columns: table => new
            ...
            migrationBuilder.CreateTable(
                name: "CmsContentTypeToFieldType",
                columns: table => new
                {
                    ContentTypeId = table.Column<int>(nullable: false),
                    FieldTypeId = table.Column<int>(nullable: false),
                    CmsContentTypeId = table.Column<int>(nullable: true),
                    CmsFieldTypeId = table.Column<int>(nullable: true),
                    Order = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CmsContentTypeToFieldType", x => new { x.ContentTypeId, x.FieldTypeId });
                    table.ForeignKey(
                        name: "FK_CmsContentTypeToFieldType_CmsContentType_CmsContentTypeId",
                        column: x => x.CmsContentTypeId,
                        principalTable: "CmsContentType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CmsContentTypeToFieldType_CmsFieldType_CmsFieldTypeId",
                        column: x => x.CmsFieldTypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionToPage", x => new { x.SectionId, x.PageId });
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("CmsContentTypeToFieldType");
            ...
            migrationBuilder.DropTable("CmsContentType");
            migrationBuilder.DropTable("CmsFieldType");
